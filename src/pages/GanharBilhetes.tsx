  ...
  return (
    <div className="min-h-screen font-fredoka bg-gradient-hero">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="bg-gray-400 dark:bg-gray-900 mt-12 border-none p-4 sm:p-6">
              ...
              {tasks.map((task) => {
                ...
                return (
                  <Card
                    ...
                    className="font-fredoka bg-gray-200 dark:bg-gray-800 shadow-card hover:shadow-glow transition-all hover:-translate-y-1 flex flex-col"
                  >
                    <CardHeader className="text-center pb-4">
